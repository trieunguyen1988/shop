...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 03, 2016 at 02:56 PM
...
DROP TABLE IF EXISTS `sh_affiliate`;
...
--
-- Table structure for table `sh_affiliate_activity`
--

DROP TABLE IF EXISTS `sh_affiliate_activity`;
CREATE TABLE `sh_affiliate_activity` (
...
--
-- Table structure for table `sh_affiliate_login`
--

DROP TABLE IF EXISTS `sh_affiliate_login`;
CREATE TABLE `sh_affiliate_login` (
...
DROP TABLE IF EXISTS `sh_affiliate_transaction`;
...
--
-- Table structure for table `sh_api`
--

DROP TABLE IF EXISTS `sh_api`;
CREATE TABLE `sh_api` (
...
--
-- Dumping data for table `sh_api`
--

INSERT INTO `sh_api` (`api_id`, `name`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2016-08-03 12:53:44', '2016-08-03 12:53:44');

-- --------------------------------------------------------

--
-- Table structure for table `sh_api_ip`
--

DROP TABLE IF EXISTS `sh_api_ip`;
CREATE TABLE `sh_api_ip` (
...
--
-- Table structure for table `sh_api_session`
--

DROP TABLE IF EXISTS `sh_api_session`;
CREATE TABLE `sh_api_session` (
...
DROP TABLE IF EXISTS `sh_attribute_description`;
...
DROP TABLE IF EXISTS `sh_attribute_group`;
...
DROP TABLE IF EXISTS `sh_attribute_group_description`;
...
INSERT INTO `sh_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
DROP TABLE IF EXISTS `sh_category_description`;
...
INSERT INTO `sh_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
DROP TABLE IF EXISTS `sh_category_filter`;
...
DROP TABLE IF EXISTS `sh_category_to_layout`;
...
DROP TABLE IF EXISTS `sh_category_to_store`;
...
DROP TABLE IF EXISTS `sh_country`;
...
DROP TABLE IF EXISTS `sh_coupon`;
...
DROP TABLE IF EXISTS `sh_coupon_category`;
...
DROP TABLE IF EXISTS `sh_coupon_history`;
...
DROP TABLE IF EXISTS `sh_coupon_product`;
...
DROP TABLE IF EXISTS `sh_currency`;
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.75040001, 1, '2016-08-03 14:54:38'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2016-08-03 14:54:38'),
(3, 'Euro', 'EUR', '', '€', '2', 0.89190000, 1, '2016-08-03 14:54:38');
...
--
-- Table structure for table `sh_customer_activity`
--

DROP TABLE IF EXISTS `sh_customer_activity`;
CREATE TABLE `sh_customer_activity` (
...
INSERT INTO `sh_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1);
...
DROP TABLE IF EXISTS `sh_customer_group_description`;
...
DROP TABLE IF EXISTS `sh_customer_history`;
...
DROP TABLE IF EXISTS `sh_customer_ip`;
...
--
-- Table structure for table `sh_customer_login`
--

DROP TABLE IF EXISTS `sh_customer_login`;
CREATE TABLE `sh_customer_login` (
...
DROP TABLE IF EXISTS `sh_customer_online`;
...
DROP TABLE IF EXISTS `sh_customer_reward`;
...
--
-- Table structure for table `sh_customer_search`
--

DROP TABLE IF EXISTS `sh_customer_search`;
CREATE TABLE `sh_customer_search` (
...
DROP TABLE IF EXISTS `sh_customer_transaction`;
...
--
-- Table structure for table `sh_customer_wishlist`
--

DROP TABLE IF EXISTS `sh_customer_wishlist`;
CREATE TABLE `sh_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `sh_custom_field`;
...
--
-- Table structure for table `sh_custom_field_customer_group`
--

DROP TABLE IF EXISTS `sh_custom_field_customer_group`;
CREATE TABLE `sh_custom_field_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sh_custom_field_description`;
...
DROP TABLE IF EXISTS `sh_custom_field_value`;
...
DROP TABLE IF EXISTS `sh_custom_field_value_description`;
...
DROP TABLE IF EXISTS `sh_download`;
...
DROP TABLE IF EXISTS `sh_download_description`;
...
INSERT INTO `sh_event` (`event_id`, `code`, `trigger`, `action`, `status`, `date_added`) VALUES
...
DROP TABLE IF EXISTS `sh_extension`;
...
DROP TABLE IF EXISTS `sh_filter`;
...
DROP TABLE IF EXISTS `sh_filter_description`;
...
DROP TABLE IF EXISTS `sh_filter_group`;
...
DROP TABLE IF EXISTS `sh_filter_group_description`;
...
DROP TABLE IF EXISTS `sh_geo_zone`;
...
DROP TABLE IF EXISTS `sh_information`;
...
DROP TABLE IF EXISTS `sh_information_description`;
...
INSERT INTO `sh_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', 'About Us', '', ''),
...
DROP TABLE IF EXISTS `sh_information_to_layout`;
...
DROP TABLE IF EXISTS `sh_information_to_store`;
...
DROP TABLE IF EXISTS `sh_language`;
...
INSERT INTO `sh_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `sort_order`, `status`) VALUES
...
DROP TABLE IF EXISTS `sh_layout`;
...
--
-- Table structure for table `sh_layout_module`
--

DROP TABLE IF EXISTS `sh_layout_module`;
CREATE TABLE `sh_layout_module` (
...
--
-- Dumping data for table `sh_layout_module`
--

INSERT INTO `sh_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
(2, 4, '0', 'content_top', 0),
(3, 4, '0', 'content_top', 1),
...
DROP TABLE IF EXISTS `sh_layout_route`;
...
DROP TABLE IF EXISTS `sh_length_class`;
...
DROP TABLE IF EXISTS `sh_length_class_description`;
...
--
-- Table structure for table `sh_location`
--

DROP TABLE IF EXISTS `sh_location`;
...
DROP TABLE IF EXISTS `sh_manufacturer`;
...
DROP TABLE IF EXISTS `sh_manufacturer_to_store`;
...
--
-- Table structure for table `sh_marketing`
--

DROP TABLE IF EXISTS `sh_marketing`;
CREATE TABLE `sh_marketing` (
...
--
-- Table structure for table `sh_menu`
--
...
--
-- Table structure for table `sh_menu_description`
--

DROP TABLE IF EXISTS `sh_menu_description`;
CREATE TABLE `sh_menu_description` (
  `menu_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `sh_menu_module`
--

DROP TABLE IF EXISTS `sh_menu_module`;
CREATE TABLE `sh_menu_module` (
...
--
-- Table structure for table `sh_modification`
--

DROP TABLE IF EXISTS `sh_modification`;
CREATE TABLE `sh_modification` (
...
--
-- Dumping data for table `sh_module`
--

INSERT INTO `sh_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
DROP TABLE IF EXISTS `sh_option`;
...
DROP TABLE IF EXISTS `sh_option_description`;
...
DROP TABLE IF EXISTS `sh_option_value`;
...
DROP TABLE IF EXISTS `sh_option_value_description`;
...
--
-- Table structure for table `sh_order_custom_field`
--

DROP TABLE IF EXISTS `sh_order_custom_field`;
CREATE TABLE `sh_order_custom_field` (
...
DROP TABLE IF EXISTS `sh_order_option`;
...
DROP TABLE IF EXISTS `sh_order_product`;
...
DROP TABLE IF EXISTS `sh_order_recurring`;
...
DROP TABLE IF EXISTS `sh_order_recurring_transaction`;
...
DROP TABLE IF EXISTS `sh_order_voucher`;
...
DROP TABLE IF EXISTS `sh_product_attribute`;
...
--
-- Dumping data for table `sh_product_attribute`
--

INSERT INTO `sh_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
DROP TABLE IF EXISTS `sh_product_description`;
...
INSERT INTO `sh_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(35, 1, 'Product 8', '&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n', '', 'Product 8', '', ''),
...
DROP TABLE IF EXISTS `sh_product_discount`;
...
--
-- Dumping data for table `sh_product_discount`
--

INSERT INTO `sh_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
DROP TABLE IF EXISTS `sh_product_filter`;
...
DROP TABLE IF EXISTS `sh_product_option`;
...
INSERT INTO `sh_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224, 35, 11, '', 1),
...
DROP TABLE IF EXISTS `sh_product_option_value`;
...
DROP TABLE IF EXISTS `sh_product_recurring`;
...
DROP TABLE IF EXISTS `sh_product_related`;
...
DROP TABLE IF EXISTS `sh_product_reward`;
...
DROP TABLE IF EXISTS `sh_product_special`;
...
--
-- Dumping data for table `sh_product_special`
--

INSERT INTO `sh_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
DROP TABLE IF EXISTS `sh_product_to_category`;
...
DROP TABLE IF EXISTS `sh_product_to_download`;
...
DROP TABLE IF EXISTS `sh_product_to_layout`;
...
DROP TABLE IF EXISTS `sh_product_to_store`;
...
--
-- Table structure for table `sh_recurring`
--

DROP TABLE IF EXISTS `sh_recurring`;
CREATE TABLE `sh_recurring` (
  `recurring_id` int(11) NOT NULL,
...
--
-- Table structure for table `sh_recurring_description`
--

DROP TABLE IF EXISTS `sh_recurring_description`;
CREATE TABLE `sh_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `sh_return`;
...
DROP TABLE IF EXISTS `sh_return_action`;
...
DROP TABLE IF EXISTS `sh_return_history`;
...
DROP TABLE IF EXISTS `sh_return_reason`;
...
DROP TABLE IF EXISTS `sh_return_status`;
...
INSERT INTO `sh_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
(174, 0, 'config', 'config_email', 'trieu.nguyennhu@gmail.com', 0),
...
(175, 0, 'config', 'config_encryption', '', 0),
...
DROP TABLE IF EXISTS `sh_stock_status`;
...
DROP TABLE IF EXISTS `sh_tax_class`;
...
DROP TABLE IF EXISTS `sh_tax_rate`;
...
DROP TABLE IF EXISTS `sh_tax_rate_to_customer_group`;
...
DROP TABLE IF EXISTS `sh_tax_rule`;
...
--
-- Table structure for table `sh_theme`
--

DROP TABLE IF EXISTS `sh_theme`;
CREATE TABLE `sh_theme` (
...
--
-- Table structure for table `sh_translation`
--

DROP TABLE IF EXISTS `sh_translation`;
CREATE TABLE `sh_translation` (
...
DROP TABLE IF EXISTS `sh_upload`;
...
DROP TABLE IF EXISTS `sh_url_alias`;
...
INSERT INTO `sh_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'trieunn', '734e647a5f38a77e20148232b36e13db6c07440d', 'rza66dt2m', 'John', 'Doe', 'trieu.nguyennhu@gmail.com', '', '', '::1', 1, '2016-08-03 12:53:44');
...
DROP TABLE IF EXISTS `sh_user_group`;
...
DROP TABLE IF EXISTS `sh_voucher`;
...
DROP TABLE IF EXISTS `sh_voucher_history`;
...
DROP TABLE IF EXISTS `sh_voucher_theme`;
...
DROP TABLE IF EXISTS `sh_voucher_theme_description`;
...
DROP TABLE IF EXISTS `sh_weight_class`;
...
DROP TABLE IF EXISTS `sh_weight_class_description`;
...
DROP TABLE IF EXISTS `sh_zone_to_geo_zone`;
...
--
-- Indexes for table `sh_affiliate_activity`
--
ALTER TABLE `sh_affiliate_activity`
  ADD PRIMARY KEY (`affiliate_activity_id`);

--
-- Indexes for table `sh_affiliate_login`
--
ALTER TABLE `sh_affiliate_login`
...
--
-- Indexes for table `sh_api`
--
ALTER TABLE `sh_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Indexes for table `sh_api_ip`
--
ALTER TABLE `sh_api_ip`
  ADD PRIMARY KEY (`api_ip_id`);

--
-- Indexes for table `sh_api_session`
--
ALTER TABLE `sh_api_session`
...
--
-- Indexes for table `sh_customer_activity`
--
ALTER TABLE `sh_customer_activity`
...
--
-- Indexes for table `sh_customer_login`
--
ALTER TABLE `sh_customer_login`
...
--
-- Indexes for table `sh_customer_search`
--
ALTER TABLE `sh_customer_search`
...
--
-- Indexes for table `sh_customer_wishlist`
--
ALTER TABLE `sh_customer_wishlist`
...
--
-- Indexes for table `sh_custom_field_customer_group`
--
ALTER TABLE `sh_custom_field_customer_group`
...
--
-- Indexes for table `sh_layout_module`
--
ALTER TABLE `sh_layout_module`
...
--
-- Indexes for table `sh_marketing`
--
ALTER TABLE `sh_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Indexes for table `sh_menu`
--
ALTER TABLE `sh_menu`
  ADD PRIMARY KEY (`menu_id`);

--
-- Indexes for table `sh_menu_description`
--
ALTER TABLE `sh_menu_description`
  ADD PRIMARY KEY (`menu_id`,`language_id`);

--
-- Indexes for table `sh_menu_module`
--
ALTER TABLE `sh_menu_module`
  ADD PRIMARY KEY (`menu_module_id`),
  ADD KEY `menu_id` (`menu_id`);

--
-- Indexes for table `sh_modification`
--
ALTER TABLE `sh_modification`
  ADD PRIMARY KEY (`modification_id`);

--
-- Indexes for table `sh_module`
--
ALTER TABLE `sh_module`
...
--
-- Indexes for table `sh_order_custom_field`
--
ALTER TABLE `sh_order_custom_field`
...
--
-- Indexes for table `sh_recurring`
--
ALTER TABLE `sh_recurring`
  ADD PRIMARY KEY (`recurring_id`);

--
-- Indexes for table `sh_recurring_description`
--
ALTER TABLE `sh_recurring_description`
...
--
-- Indexes for table `sh_theme`
--
ALTER TABLE `sh_theme`
  ADD PRIMARY KEY (`theme_id`);

--
-- Indexes for table `sh_translation`
--
ALTER TABLE `sh_translation`
...
--
-- AUTO_INCREMENT for table `sh_affiliate_activity`
--
ALTER TABLE `sh_affiliate_activity`
  MODIFY `affiliate_activity_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sh_affiliate_login`
--
ALTER TABLE `sh_affiliate_login`
...
--
-- AUTO_INCREMENT for table `sh_api`
--
ALTER TABLE `sh_api`
  MODIFY `api_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sh_api_ip`
--
ALTER TABLE `sh_api_ip`
  MODIFY `api_ip_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sh_api_session`
--
ALTER TABLE `sh_api_session`
...
--
-- AUTO_INCREMENT for table `sh_cart`
--
ALTER TABLE `sh_cart`
...
--
-- AUTO_INCREMENT for table `sh_customer_activity`
--
ALTER TABLE `sh_customer_activity`
...
--
-- AUTO_INCREMENT for table `sh_customer_login`
--
ALTER TABLE `sh_customer_login`
...
--
-- AUTO_INCREMENT for table `sh_customer_search`
--
ALTER TABLE `sh_customer_search`
...
--
-- AUTO_INCREMENT for table `sh_layout_module`
--
ALTER TABLE `sh_layout_module`
...
--
-- AUTO_INCREMENT for table `sh_location`
--
ALTER TABLE `sh_location`
...
--
-- AUTO_INCREMENT for table `sh_marketing`
--
ALTER TABLE `sh_marketing`
  MODIFY `marketing_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sh_menu`
--
ALTER TABLE `sh_menu`
  MODIFY `menu_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sh_modification`
--
ALTER TABLE `sh_modification`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sh_module`
--
ALTER TABLE `sh_module`
...
--
-- AUTO_INCREMENT for table `sh_order_custom_field`
--
ALTER TABLE `sh_order_custom_field`
...
--
-- AUTO_INCREMENT for table `sh_recurring`
--
ALTER TABLE `sh_recurring`
...
--
-- AUTO_INCREMENT for table `sh_theme`
--
ALTER TABLE `sh_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sh_translation`
--
ALTER TABLE `sh_translation`
